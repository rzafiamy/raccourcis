  ...
  // ── Media ───────────────────────────────────────────────────────
  {
    ...
    steps: [
      ...
      },
      {
        ...
        desc: 'Detailed description and text extraction',
        icon: 'panel-top',
        color: '#AF52DE',
        label: 'Image Details',
      },
    ...
    steps: [
      {
        type: 'user-input',
        title: 'Audio File',
        desc: 'Path to local audio file',
        icon: 'file-audio',
        color: '#FF9F0A',
        label: 'Audio File Path',
        placeholder: '/home/user/recording.mp3',
      },
      {
        type: 'asr',
        title: 'Transcribe',
    ...
    steps: [
      {
        type: 'user-input',
        title: 'Art Prompt',
        desc: 'What should the AI create?',
        icon: 'wand-2',
        color: '#FF2D55',
        label: 'Image Prompt',
  ...
  // ── Communication ───────────────────────────────────────────────
  {
    ...
    steps: [
      ...
      },
      {
        type: 'smtp-send',
        title: 'Send SMTP',
        desc: 'Send via custom mail server',
        icon: 'send',
        color: '#5E5CE6',
        to: '{{vars.toEmail}}',
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        type: 'show-result',
        title: 'Transcription',
        desc: 'Your voice note turned into text',
        icon: 'panel-top',
        color: '#FF9F0A',
        label: 'Voice Note',
      },
